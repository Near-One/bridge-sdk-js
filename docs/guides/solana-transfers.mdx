...
This guide covers transferring tokens from Solana to other supported chains.
...
<Warning>
  PDA seeds must match the on-chain program exactly. Don't modify them — use the builder's derive methods.
</Warning>
