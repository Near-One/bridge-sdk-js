...
Relayers are third-party services that finalize transfers on destination chains automatically. By including a relayer fee in your transfer, you don't need to manually finalize on the destination chain.
