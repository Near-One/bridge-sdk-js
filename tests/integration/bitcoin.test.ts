...
describe("Bitcoin Integration Tests", () => {
  ...
  beforeEach(() => {
    ...
    client = new NearBridgeClient(mockNear, REAL_WITHDRAWAL_DATA.bridgeContract, {
      defaultSignerId: REAL_WITHDRAWAL_DATA.testAccount,
    })
  })
  ...
  describe("End-to-End Deposit Flow", () => {
    it("should complete full deposit flow using real transaction data", async () => {
      ...
      const depositAddressResult = await client.getUtxoDepositAddress(
        ChainKind.Btc,
  ...
  describe("Error Scenarios and Recovery", () => {
    ...
    it("should handle NEAR contract failures", async () => {
      ...
      await expect(client.getUtxoBridgeConfig(ChainKind.Btc)).rejects.toThrow(
  ...
  describe("Performance and Scalability", () => {
    it("should handle multiple concurrent operations", async () => {
      ...
      const promises = Array(5)
        .fill(null)
        .map(() => client.getUtxoBridgeConfig(ChainKind.Btc))
